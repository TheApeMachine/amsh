...
type WaveFunction struct {
	...
	Time          time.Time       `json:"time" jsonschema:"required,title=Time,description=Time of the wave function"`
}
...
type SuperpositionState struct {
	...
	Lifetime      time.Duration      `json:"lifetime" jsonschema:"required,title=Lifetime,description=Expected lifetime"`
}
...
type Entanglement struct {
	...
	Duration time.Duration `json:"duration" jsonschema:"required,title=Duration,description=Expected duration"`
}
