...
require (
	...
	github.com/soluchok/freeproxy v0.0.0-20200112224202-ccb33291a087 // indirect
	github.com/soluchok/go-cloudflare-scraper v0.0.0-20190117212330-ecf651d4e614 // indirect
